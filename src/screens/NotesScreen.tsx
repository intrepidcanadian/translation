...
export default function NotesScreen() {
  ...
  // Reload notes every time this tab comes into focus
  useFocusEffect(
    useCallback(() => {
      reload();
      setSearch("");
        ...
        ListEmptyComponent={
          <View style={styles.emptyState}>
            ...
            <Text style={[styles.emptyHint, { color: colors.dimText }]}>
              {search ? "Try a different search" : "Use the Scan tab to scan documents and save notes"}
            </Text>
          </View>
        }
...
const styles = StyleSheet.create({
  ...
  clearSearch: { fontSize: 16, fontWeight: "700", padding: 4 },
  ...
  noteCardHeader: { flexDirection: "row", alignItems: "center", gap: 10, marginBottom: 6 },
  noteCardIcon: { fontSize: 24 },
  noteCardMeta: { flex: 1 },
  noteCardTitle: { fontSize: 15, fontWeight: "700" },
  noteCardSub: { fontSize: 12, marginTop: 2 },
  deleteIcon: { fontSize: 16, fontWeight: "700", padding: 4 },
  noteCardFields: { flexDirection: "row", flexWrap: "wrap", gap: 6, marginBottom: 6 },
  fieldChip: { borderRadius: 6, paddingVertical: 3, paddingHorizontal: 8, borderWidth: 1, maxWidth: "80%" },
  fieldChipText: { fontSize: 12 },
  moreFields: { fontSize: 12, alignSelf: "center" },
  noteCardPreview: { fontSize: 13, lineHeight: 18 },
  detailContent: { padding: 16 },
  section: { borderRadius: 12, padding: 16, marginBottom: 12, borderWidth: 1 },
  sectionHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  sectionTitle: { fontSize: 16, fontWeight: "700", marginBottom: 8 },
  noteDetailTitle: { fontSize: 20, fontWeight: "700" },
  editHint: { fontSize: 12, marginTop: 4 },
  titleEditRow: { flexDirection: "row", alignItems: "center", gap: 10 },
  titleInput: { flex: 1, fontSize: 18, fontWeight: "600", borderBottomWidth: 1, paddingVertical: 6 },
  metaRow: { flexDirection: "row", justifyContent: "space-between", borderRadius: 10, padding: 12, marginBottom: 12, borderWidth: 1 },
  metaText: { fontSize: 13, fontWeight: "500" },
  fieldRow: { paddingVertical: 8, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: "rgba(128,128,128,0.2)" },
  fieldLabel: { fontSize: 12, fontWeight: "600", textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 2 },
